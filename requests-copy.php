...
<body class="bg-fixed bg-no-repeat bg-cover bg-center bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-[#f3f4f5] via-[#e0e8ed] to-[#d0dde6]">
  ...
  <div class="pr-12">
    ...
    <div class="container pt-20">
            <div class="row">
                <div class="col-md-5">
                    <video id="preview"  style="  border-radius: 10px; width: 180px; height: 180px; padding: top 30px; object-fit: cover;"></video>
                </div>
    ...
    <script>
        ...
        <div class="flex flex-col items-center">
          ...
          while ($row = mysqli_fetch_assoc($result)) { ?>
            ...
            <td name="<?=$row['student_num'];?>"><?php echo $row["student_num"]; ?></td>
            <td name="<?=$row['ctrl_num'];?>"><?php echo $row["ctrl_num"]; ?></td>
            <td name="<?=$row['yr_sec'];?>"><?php echo $row["yr_sec"]; ?></td>
            <td name="<?=$row['program'];?>"><?php echo $row["program"]; ?></td>
            <td name="<?=$row['reqtype'];?>"><?php echo $row["reqtype"]; ?></td>
            <td>
